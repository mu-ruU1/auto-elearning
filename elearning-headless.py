...
for a in range(library.trynum):
    ...
    colorama.init()
    print(colorama.Back.GREEN + colorama.Fore.BLACK + "\n\n >>>> %d ／ %d 完了しています \n\n" % (a+1,library.trynum))
    print(colorama.Style.RESET_ALL,end="")
    colorama.deinit()

driver.close()
colorama.init()
print(colorama.Back.WHITE + colorama.Fore.BLUE + "正常に完了しました\n\n")
print(colorama.Style.RESET_ALL,end="")
colorama.deinit()
...
colorama.init()
print(colorama.Back.WHITE + colorama.Fore.RED + "終了します.....")
print(colorama.Style.RESET_ALL,end="")
colorama.deinit()
